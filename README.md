...
- Cleaned up style.css to remove unused styles
- images adjusted--look good in mobile view
...
- Adding changes from 12/19 work session
- Refined form section--checks out in mobile, 769px, and responsive desktop version
- Removed previous stay section that was submitted--HTML was commented out in last commit


11/27
- Fixed stay form to be aligned horizontally with no wrap
